...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { category: @notice.category, content: @notice.content, title: @notice.title, user_id: @notice.user_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { category: @notice.category, content: @notice.content, title: @notice.title, user_id: @notice.user_id } }
